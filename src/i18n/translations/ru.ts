...
export const ru: Translations = {
  ...
  // -------------------------------------------------- экспорт и импорт
  "transfer.shareAction": "Поделиться расписанием",
  "transfer.shareDialogTitle": "Поделиться расписанием",
  "transfer.importAction": "Импортировать расписание",
  "transfer.importPreviewTitle": "Импорт расписания",
  "transfer.importClasses": "Занятий",
  "transfer.importConfirm": "Импортировать",
  "transfer.importAsArchive": "Оно попадёт в архив. Текущее расписание останется без изменений.",
  "transfer.importAsActive": "Оно станет вашим расписанием.",
  "transfer.importedNotice": "Расписание импортировано. Восстановите его, когда захотите им пользоваться.",
  "transfer.importHint": "Выберите файл .temelo или отправьте его в Temelo из другого приложения.",
  "transfer.selectionActions": "Действия: {name}",

  "transfer.shareOrExport": "Поделиться / Экспорт",
  "transfer.shareFileAction": "Файл Temelo",
  "transfer.shareFileHint": "Для резервной копии или импорта в Temelo.",
  "calendarExport.action": "Экспорт в календарь",
  "calendarExport.actionHint": "Создать файл календаря за выбранный период.",
  "calendarExport.title": "Экспорт в календарь",
  "calendarExport.dialogTitle": "Экспорт в календарь",
  "calendarExport.from": "С",
  "calendarExport.to": "По",
  "calendarExport.fromTitle": "Первый день",
  "calendarExport.toTitle": "Последний день",
  "calendarExport.note":
    "Создаёт разовый файл календаря за эти даты. Дальнейшие изменения в Temelo в него не попадут.",
  "calendarExport.confirm": "Экспортировать",
  "calendarExport.openInCalendar": "Открыть в календаре",
  "calendarExport.shareFile": "Отправить файл календаря",
  "calendarExport.noAppHint": "Отправьте файл календаря другим способом.",
  "calendarExport.emptyHint": "Выберите другие даты, чтобы экспортировать файл календаря.",
  "calendarExport.teacherLine": "Преподаватель: {name}",
  "share.readingTitle": "Чтение файла…",
  "share.importedTitle": "Расписание импортировано",
  "share.importedBody": "«{name}» добавлено в Temelo.",
  "share.importedAsActive": "Откройте Temelo, чтобы увидеть его.",
  "share.importedAsArchive": "Откройте Temelo — оно в архиве расписаний.",
  "share.failedTitle": "Не удалось импортировать этот файл",
  ...
  "errors.fileNotTemelo": "Это не файл расписания Temelo.",
  "errors.fileFutureVersion": "Это расписание создано в более новой версии Temelo. Обновите приложение, чтобы его открыть.",
  "errors.fileDamaged": "Файл расписания Temelo повреждён — импортировать его нельзя.",
  "errors.fileTooLarge": "Файл слишком большой для расписания Temelo.",
  "errors.fileUnreadable": "Не удалось прочитать файл.",
  "errors.shareUnavailable": "На этом устройстве нельзя отправить файл.",
  "errors.calendarRangeInvalid": "Последний день не может быть раньше первого.",
  "errors.calendarRangeTooLong": "Выберите период не длиннее {days} дней.",
  "errors.calendarNoClasses": "В этот период занятий нет.",
  "errors.calendarNoApp": "Нет приложения календаря, чтобы открыть файл.",
  "errors.calendarExportFailed": "Не удалось экспортировать календарь.",
  "errors.shareFailed": "Не удалось отправить расписание.",
